...
import 'package:first_flutter_app/view/auth/email_login_dialog.dart';
  ...
  void _signIn(SignType type, String email , String password) async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        ChatUser craftyUser = ChatUser(email: email, password: password);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Image.asset('assets/logo2.png', height:300),
              SizedBox(
                height: 20,
              ),
              SignInButton(
                ...
                onPressed: () async {
                  ChatUser user = await Get.to(SignUpWithEmailPage());
                  if (user != null){
              ...
              MaterialButton(
                onPressed: () async {
                  ChatUser user = await Get.to(LoginWithEmailPage());
                  if (user != null){
