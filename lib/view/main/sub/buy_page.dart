...
import 'package:first_flutter_app/data/crafty_kind.dart';
              ...
              child: InkWell(
                child: Stack(
                  children: [
                    ...
                    _selectedPost.sell == true ?  SizedBox(height: 100, child: Icon(Icons.chat_bubble),) : Container()
                  ],
                ),
                onTap: () {
                  // 아이템 상세 페이지로 이동
